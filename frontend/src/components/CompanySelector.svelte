...
<div class="mt-20 flex justify-center items-center h-fit">
  ...
  <div class="text-center">
    ...
    <p class="text-lg text-gray-400 mt-2">Welcome, investment decision calculator will rank the companies according to one of the for MCDA methods that are available below. You can find the criteria list on separate page. Please choose at least two companies from list below and then choose an MCDA method.</p>
  </div>
</div>
